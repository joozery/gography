...
const Hero = () => {
  ...
  return (
    <div className="bg-black/20 h-full font-prompt">
      <div className="h-full flex justify-center items-center p-4 bg-primary/10">
        <div className="container grid grid-cols-1 gap-4">
          ...
          >
              ...
              <div>
                ...
                <div className="bg-gray-100 rounded-full p-2 flex items-center justify-center">
                  <input
                    ...
                    name="destination"
                    id="destination"
                    className="appearance-none w-full bg-gradient-to-r from-gray-600 to-gray-800 h-2 rounded-full my-2"
                    min="150"
                    max="1000"
                    value={priceValue}
                    step="10"
            ...
            <button className="bg-gradient-to-r from-gray-600 to-gray-800 text-white hover:scale-105 px-4 py-2 rounded-full duration-200 absolute -bottom-5 left-1/2 -translate-x-1/2">
              Search Now
            </button>
          </div>
        </div>
